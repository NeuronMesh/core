...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [NeuronMesh](https://github.com/NeuronMesh) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for NeuronMesh.
...
```bash
git clone https://github.com/NeuronMesh/core
cd core
go mod download
```
